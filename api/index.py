...
def create_purchase_order():
    ...
    try:
        ...
        cur.execute(
            """
            INSERT INTO purchase_orders (po_number, brand, supplier_name, status, notes, created_by)
            VALUES (%s, %s, %s, 'open', %s, %s)
            RETURNING *
            """,
            (po_number, brand, supplier_name, notes, created_by),
        )
        ...
        for item in items:
            ...
            cur.execute(
                ...
                INSERT INTO purchase_order_items
                  (po_id, product_id, product_name, unit, ordered_qty, purchase_price)
                VALUES (%s, %s, %s, %s, %s, %s)
                """,
...
def receive_purchase_order(po_id: int):
    ...
    try:
        ...
        for item in items:
            ...
            # Update product stock + write inventory transaction
            pid = poi["product_id"]
            cur.execute(
