...
def create_product():
    ...
    minimum_stock_level = body.get("minimum_stock_level", 0)
    ...
    try:
        ...
        cur.execute(
            """
            INSERT INTO products (name, barcode, brand, category_id, subcategory, unit, purchase_price, mrp, selling_price, gst_percentage, current_stock, minimum_stock_level, quick_sale_enabled, active)
            VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)
            RETURNING *
            """,
            (name, barcode or None, brand or None, category_id, subcategory or None, unit, purchase_price, mrp, selling_price, gst_percentage, current_stock, minimum_stock_level, quick_sale_enabled, active),
        )
